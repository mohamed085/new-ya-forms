    ...
    <div v-if="getLang === 'en'" class="main-content en animate__animated animate__backInLeft">
      ...
      <div v-else class="container">
        ...
        <div class="create-form">
          ...
          <b-button class="btn mb-3" @click="addForm">Save Template</b-button>
        </div>
...
export default {
  ...
  methods: {
    ...
    async addForm() {
      ...
      let url = "https://yaformelbanna.we-work.pro/api/auth/create-template";
      ...
      url = `https://yaformelbanna.we-work.pro/api/auth/append-template/` + form_id;
