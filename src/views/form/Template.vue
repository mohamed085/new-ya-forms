<template>
  ...
  <div v-else :class="'home animate__animated animate__fadeIn ' + form.style_theme + ' ' + form.font_family ">
    ...
    <div>
      ...
      <div class="main-content ar animate__animated animate__backInRight mt-3" v-if="getLang === 'ar'">
...
import SendForm from "@/views/form/SendForm";
...
export default {
  ...
  methods: {
            ...
            this.form.questions.push(
                {
                  ...
                  question_type: 'image',
                  required: '',
                  description: result.data.file_name,
                  focus: true,
                });
    ...
    async addForm() {
      ...
      let url = "https://yaformelbanna.we-work.pro/api/auth/create-form";
      ...
      let form_id = responseData.data;

      url = `https://yaformelbanna.we-work.pro/api/auth/append-form/` + form_id;
    ...
    async loadForm(id) {
      ...
      let url = `https://yaformelbanna.we-work.pro/api/auth/get-template/` + id;
