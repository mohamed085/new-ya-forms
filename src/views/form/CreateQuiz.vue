<template>
  <div :class="'home animate__animated animate__fadeIn ' + form.style_theme + ' ' + form.font_family ">
    ...
    <div class="select-form-type" v-if="form.form_type === ''">
            ...
            <div @click="divFocus(question)" v-for="question in form.questions" :key="question.id" :class="'form-question ' + question.focus ">
              ...
              <div v-if="question.type === 'question'" class="question-type">
                ...
                <div v-else-if="question.question_type == 'Multiple choice'" class="form-question-row-2 choice-row">
                  ...
                  <b-form-input class="multiple-choice-input" type="text" v-model="question.default_answer" placeholder="Add answer"></b-form-input>
                </div>
              ...
              <div v-if="question.type === 'question'" class="question-type">
                ...
                <div class="form-question-row-1">
                  ...
                  <b-form-select class="select-answer" v-model="question.question_type">
                    ...
                    <b-form-select-option value="Number">عدد الجواب</b-form-select-option>
                ...
                <div v-else-if="question.question_type == 'Checkboxes'" class="form-question-row-2 choice-row">
                  ...
                  <b-form-input class="multiple-choice-input" type="text" v-model="question.default_answer" placeholder="أضف إجابة"></b-form-input>
                </div>
...
export default {
  ...
  data() {
    return {
      error: '',
      form: {
        form_type: 'classic form',
        image_header: '',
        header: 'Untitled Quiz',
        is_template: false,
        is_quiz: true,
  ...
  methods: {
    ...
    async addForm() {
      ...
      let url = "https://yaformelbanna.we-work.pro/api/auth/create-quiz";

      await fetch(url, requestOptions)
          .then(response => response.json())
          .then(result => {
            let form_id = result.data;
            url = `https://yaformelbanna.we-work.pro/api/auth/append-quiz/` + form_id;
